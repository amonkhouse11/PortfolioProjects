/* Adapted from Working_code_cleaned.sas (amonkhouse11/SQL-Practice).
   Same PROC SURVEYLOGISTIC design (strata/cluster/weight, link=glogit)
   as the source, run against a small inline mock `nhanes` dataset with
   PHQ2/TBI2 dichotomous flags derived the same way as the source. */
